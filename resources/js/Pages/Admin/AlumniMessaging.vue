                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="alumnus in alumni.data" :key="alumnus.id">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      ...
                      <div v-if="alumnus.contact_number" class="text-sm text-gray-500">{{ alumnus.contact_number }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-500">{{ alumnus.degree_earned }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-500">{{ alumnus.year_graduated }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div v-if="alumnus.last_message_sent" class="text-sm text-gray-500">{{ alumnus.last_message_sent }}</div>
      ...
      <div class="modal-container">
        ...
        <div class="modal-body">
          ...
          <form @submit.prevent="sendBulkMessage" v-if="!loading">
            ...
            <div class="mb-4">
              <label for="bulk-content" class="block text-sm font-medium text-gray-700">Message</label>
              <textarea
