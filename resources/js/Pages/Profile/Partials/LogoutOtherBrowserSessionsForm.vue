    ...
    <div class="profile-management-container">
      <div class="profile-card">
        ...
        <div v-if="sessions.length > 0" class="mt-5">
          <div v-for="(session, i) in sessions" :key="i" class="session-item">
            <div class="session-icon">
              <svg v-if="session.agent.is_desktop" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
